...
val get_num_of_exn : QualifiedIdent * int -> int;
val get_exn_of_num : int -> QualifiedIdent * int;
val defineGlobalExceptionAlias :
  QualifiedIdent * (QualifiedIdent * int) -> unit;
...
val normalizeExnName : QualifiedIdent -> QualifiedIdent;
