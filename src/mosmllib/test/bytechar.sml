...
val test9 = check("" = Byte.unpackString(Word8ArraySlice.slice(Word8Array.fromList [], 0, SOME 0)));

local
    val arr = Word8Array.tabulate(10, fn i => Word8.fromInt(i+65))
in
val test10a = check("" = Byte.unpackString(Word8ArraySlice.slice(arr, 0, SOME 0)));
val test10b = check("" = Byte.unpackString(Word8ArraySlice.slice(arr, 10, SOME 0))
 		   andalso "" = Byte.unpackString(Word8ArraySlice.slice(arr, 10, NONE)));
val test10c = check("BCDE" = Byte.unpackString(Word8ArraySlice.slice(arr, 1, SOME 4)));
val test10d = (Byte.unpackString(Word8ArraySlice.slice(arr, ~1, SOME 0)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10e = (Byte.unpackString(Word8ArraySlice.slice(arr, 11, SOME 0)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10f = (Byte.unpackString(Word8ArraySlice.slice(arr, 0, SOME ~1)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10g = (Byte.unpackString(Word8ArraySlice.slice(arr, 0, SOME 11)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10h = (Byte.unpackString(Word8ArraySlice.slice(arr, 10, SOME 1)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10i = (Byte.unpackString(Word8ArraySlice.slice(arr, ~1, NONE)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test10j = (Byte.unpackString(Word8ArraySlice.slice(arr, 11, NONE)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
end
...
in
val test11a = check("" = Byte.unpackStringVec(Word8VectorSlice.slice(vec, 0, SOME 0)));
val test11b = check("" = Byte.unpackStringVec(Word8VectorSlice.slice(vec, 10, SOME 0))
 		   andalso "" = Byte.unpackStringVec(Word8VectorSlice.slice(vec, 10, NONE)));
val test11c = check("BCDE" = Byte.unpackStringVec(Word8VectorSlice.slice(vec, 1, SOME 4)));
val test11d = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, ~1, SOME 0)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11e = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, 11, SOME 0)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11f = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, 0, SOME ~1)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11g = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, 0, SOME 11)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11h = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, 10, SOME 1)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11i = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, ~1, NONE)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
val test11j = (Byte.unpackStringVec(Word8VectorSlice.slice(vec, 11, NONE)) seq "WRONG")
              handle Subscript => "OK" | _ => "WRONG";
end
