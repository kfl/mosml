...
val test7 =
    List.map (fn(x, y) => check(x == y))
             [ (i64 ~42             , ~(i64 42))
             , (abs(i64 ~42)        , i64 42)
             , (abs(i64 42)         , i64 42)
             , (~(~(i64 42))        , i64 42)
             , (i64 21 + i64 21     , i64 42)
             , (i64 2 * i64 21      , i64 42)
             , (i64 21 + i64 21     , i64 42)
             , (i64 ~42 - i64 42    , i64 ~84)
             , (valOf maxInt + i64 0   , valOf maxInt)
             , (valOf minInt + i64 0   , valOf minInt)
             , (valOf maxInt - i64 0   , valOf maxInt)
             , (valOf minInt - i64 0   , valOf minInt)
             , (valOf maxInt * i64 1   , valOf maxInt)
             , (valOf minInt * i64 1   , valOf minInt)
             , (valOf minInt div i64 1 , valOf minInt)
             , (valOf minInt quot i64 1, valOf minInt)
