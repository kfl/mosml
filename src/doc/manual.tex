...
A toplevel-mode compilation unit may contain arbitrary Moscow ML toplevel declarations,
and consequently, arbitrary Standard ML toplevel declarations (including functor, 
signature and fixity declarations). 
...
\noindent
which is equivalent to issuing the individual commands:
\begin{program}
...
\noindent and, therefore, does not avoid unnecessary recompilation steps.

\section{Recompilation management using {\tt mosmldep} and {\tt make}}
