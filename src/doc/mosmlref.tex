% mosmlref.tex v. 2.00.0 Copyright (C) Peter Sestoft 1994, 2000-06-15
%
...
\usepackage{isolatin1,mosml,a4wide,pslatex}
...
\item Moscow ML phrases that are non-compliant 
      ...
      marked with an asterisk (\x) in the margin.
    ...
    \item Moscow ML phrases that are non-compliant generalisations of
      ...
      ML, are marked with an an asterisk and a number (\x[$N$]) in the
...
\noindent is roughly equivalent to
...
\subsection*{Vector manipulation functions (module {\tt Vector})}
